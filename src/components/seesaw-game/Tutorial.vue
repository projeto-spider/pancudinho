...
import Game from './FinalGame.vue'
...
export default {
  ...
  data: () => ({
    ...
    tutorial: [
        ...
        {
          text: 'Mantendo o clique do mouse pressionado sobre o peso de chumbo do lado direito da gangorra, sua massa irá aumentar.'
        },
        {
          text: 'Caso solte o clique, essa massa irá diminuir.'
        },
        {
          text: 'Você precisa igualar a massa do peso de chumbo e do Pançudinho por exatamente 3 segundos para vencer!'
        },
        {
          text: 'Está Pronto?'
        },
