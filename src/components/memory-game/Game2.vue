...
<div>
      <div v-if='visualNovel'>
          ...
          <h2 v-if='tutorialExample'>Score: 1000</h2>
          <h2 v-if='tutorialExample2'>Score: 900</h2>
...
export default {
  ...
  methods: {
    ...
    handleClick () {
      ...
      if (this.tutorial[this.counter2].text === this.showText2) {
    ...
    tutorialScenes(){
      if (this.counter2 == 3) {
        this.tutorialScene1 ()
        this.tutorialExample = true
      } else if (this.counter2 == 4) {
        this.tutorialScene2 ()
        this.tutorialExample = false
    ...
    tutorialScene1 () {
       for (let i = 1; i < this.cardsInGame.length; i++){
         if (this.cardsInGame[i].group === this.cardsInGame[0].group){
           this.index = i
           break
         }
       }
       ...
       this.cardsInGame[this.index].flip = true
       this.setCardColor(this.cardsInGame[0], this.cardsInGame[this.index])
